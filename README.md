...
- Guest login includes **sample demo data** (expenses, loans, cards, monetary, and events of every type). Guest **adds** are removed on logout; **edits** to demo rows reset to the baseline; demo sample data stays for the next guest session.
