 ...
 */
async function insertEqualSplitExpense(groupId, description, amount, paidByMemberId, expenseDate, memberIds, notes = null) {
...
/**
 * Splits demo: 2 groups, shared expenses, balances, one settlement.
 */
async function seedDemoSplits(userId) {
  ...
  // You paid dinner for everyone
  await insertEqualSplitExpense(
    g1,
    'Beach dinner',
    4800,
    goaIds.You,
  ...
  // Partial settlement: Deepak paid You
  await query(
  ...
  // Settlement: You paid Meera her share already
  await query(
    `INSERT INTO split_settlements
       (group_id, from_member_id, to_member_id, amount, settled_date, notes)
     VALUES ($1,$2,$3,$4,$5,$6)`,
