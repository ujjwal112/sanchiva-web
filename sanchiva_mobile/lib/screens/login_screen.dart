...
/// Login — respects app light/dark theme (sheet, fields, buttons).
class LoginScreen extends StatefulWidget {
  const LoginScreen({super.key, this.onCreateAccount});
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _guest() async {
    ...
    try {
      await context.read<AuthState>().loginGuest();
      clearNavStack();
    } catch (e) {
      if (!mounted) return;
      setState(() => _localError = e.toString().replaceFirst('ApiException: ', ''));
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Sign in to your Sanchiva account',
                        style: GoogleFonts.inter(
                        ...
                        child: Column(
                          ...
                          children: [
                            TextFormField(
                              ...
                              style: GoogleFonts.inter(fontWeight: FontWeight.w600, color: ink),
                                ...
                                onPressed: _busy
                                    ...
                                    : () async {
                                        ...
                                        try {
                                          ...
                                          if (!mounted) return;
                                          await photo.preferGoogleIfUnset(
                                            hasGooglePhoto: auth.googlePhotoUrl != null,
                                          );
                                          if (auth.googlePhotoUrl != null) {
                                            await photo.useGoogle();
                                          }
                                          if (!mounted) return;
                                          clearNavStack();
